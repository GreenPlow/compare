...
# def test_create_instance_of_validate_and_validate_input(
#     mocker, fixture_args_helper, fixture_validate
# ):
...
# def test_if_validate_input_is_false_exit_script(
#     mocker, fixture_args_helper, fixture_validate
# ):
...
# def test_if_validate_input_is_true_print_text(
#     mocker, fixture_args_helper, fixture_validate
# ):
